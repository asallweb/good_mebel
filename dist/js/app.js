(() => {
    ...
    (() => {
        ...
        new lazyload_min({
            elements_selector: "[data-src],[data-srcset],.load-lazy",
        ...
        function initSliders() {
            ...
            if (document.querySelector(".mebel-zakaz__slider")) new core(".mebel-zakaz__slider", {
            ...
            if (document.querySelector(".products-slider__slider-1")) new core(".products-slider__slider-1", {
                modules: [ Navigation, Pagination, Lazy ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".products-slider__slider-2")) new core(".products-slider__slider-2", {
                modules: [ Navigation, Pagination, Lazy ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".products-slider__slider-3")) new core(".products-slider__slider-3", {
                modules: [ Navigation, Pagination, Lazy ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".products-slider__slider-7")) new core(".products-slider__slider-7", {
                modules: [ Navigation, Pagination, Lazy ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".categories__slider")) {
                ...
                function swiperCard() {
                    if (window.innerWidth <= 1180) {
                        if (!init) {
                            init = true;
                            swiper = new core(".categories__slider", {
                                modules: [ Navigation, Pagination, Lazy ],
                                observer: true,
                                observeParents: true,
                                slidesPerView: "auto",
                ...
                function sliderMouseSlideInit() {
                    document.addEventListener("mousemove", (function(e) {
                        ...
                        if (targetElement.closest("[data-mousemove-swipe]")) {
                            ...
                            const sliderLength = sliderItem ? sliderItem.slides.length : 0;
                            if (sliderLength > 1) {
            ...
            if (document.querySelector(".product-slider")) {
                ...
                new core(".product-slider__images .swiper-container", {
                    modules: [ Navigation, Pagination, Thumb, Lazy ],
                    direction: "vertical",
                    slidesPerView: 1,
                    spaceBetween: 32,
                    mousewheel: true,
...
***************************************************************************** */
        ...
        tagButtons.forEach((tagButton => {
            tagButton.addEventListener("click", (() => {
                ...
                const popupToShow = document.getElementById(popupId);
                if ("none" === popupToShow.style.display) popupToShow.style.display = "block";
            }));
        }));
        ...
        if (searchInput && brandsFilter) searchInput.addEventListener("input", (() => {
            ...
            if (visibleBrandLinks.length <= 5) moreBrandsBtn.style.display = "none"; else moreBrandsBtn.style.display = "block";
        }));
        ...
        if (popupSearchInputCity) popupSearchInputCity.addEventListener("input", (function() {
            ...
            for (let i = 0; i < cityLinks.length; i++) {
                ...
                if (cityName.includes(searchTerm)) {
                    ...
                    hasResults = true;
                } else cityLink.style.display = "none";
            }
            if (hasResults) popupSearchNoResults.style.display = "none"; else popupSearchNoResults.style.display = searchTerm ? "block" : "none";
        }));
        if (popupSearchClear) popupSearchClear.addEventListener("click", (function() {
        ...
        if (phoneInputs) phoneInputs.forEach((input => {
        ...
        function showMenu(event) {
            ...
            menuBlocks.forEach((block => {
                ...
                if (catalogId === showMenuId) block.classList.add("_active");
            }));
        }
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (showBtn) document.addEventListener("click", (function(e) {
